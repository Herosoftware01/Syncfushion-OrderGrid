      ...
      <div className='grid-container'
        ...
        >
          <ColumnsDirective>
            ...
            <ColumnDirective field="director_sample_order" headerText="dir" width="90" maxWidth="200" filterBarTemplate={multiSelectFilterTemplate} customAttributes={{ class: 'editCss' }} />
